...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key={{ config('services.google.maps_key') }}&libraries=places,marker&v=beta&language=zh-TW&callback=initMap" async defer></script>
